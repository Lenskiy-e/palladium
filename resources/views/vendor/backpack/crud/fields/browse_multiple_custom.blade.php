...
<div @include('crud::inc.field_wrapper_attributes') >
    ...
    @if ($multiple)
        ...
        @foreach((array)$value as $v)
            @if ($v)
                <div class="input-group input-group-sm">
                    <img width="100%" style="max-width: 300px" src="/{{ $v }}" alt="image" >
                    <input type="text" name="{{ $field['name'] }}[]" value="{{ $v }}" @include('crud::inc.field_attributes') readonly>
                    <input type="text" name="photo_order[]" value="0" @include('crud::inc.field_attributes')>
        ...
        @endforeach
    @else
        <img width="30%" style="max-width: 300px" src="/{{ $value }}" alt="image" >
...
<script type="text/html" id="browse_multiple_template_{{ $field['name'] }}">
    <div class="input-group input-group-sm">
        <img width="100%" style="max-width: 300px" alt="image" >
                ...
                div.elfinder({
                    ...
                    getFileCallback: function (files) {
                        ...
                        files.forEach(function (file) {
                            var input = $(template);
                            input.find('input[name="{{ $field['name'] }}[]"]').val(file.path);
                            input.find('img').attr('src','/' + file.path);

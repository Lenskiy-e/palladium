...
@if ($crud->checkIfFieldIsFirstOfItsType($field))
    ...
    <!-- include select2 js-->
    <script src="{{ asset('vendor/adminlte/bower_components/select2/dist/js/select2.js') }}"></script>
    @endpush
@endif
                        ...
                        processResults: function (data, params) {
                            ...
                            var result = {
                                results: $.map(data.data, function (item) {
                                    ...
                                    return {
                                        text: "{{$field['translatable']}}" ? item[textField].ru : item[textField],
                            ...
                            console.log("{{ $connected_entity_key_name }}"); 
                            return result;
                        },
                        cache: true
                    },
